-- 2 hotels in Angers
INSERT INTO hotels (hotel_id, name, street, zipcode, city, rating)
VALUES (10, 'Urban Retreat hotel', '5 Rue du Château', '49000', 'Angers', 4.0),
...
VALUES (40, 'Downtown Digs', '8 Boulevard Voltaire', '44000', 'Nantes', 1.8),
       ...
       (70, 'Harbor hotel', '3 Quai des Marins', '44000', 'Nantes', 1.0);


-- Bedrooms for 'Urban Retreat hotel' in Angers
INSERT INTO bedrooms (room_id, room_number, price, hotel_id)
...
-- Bedrooms for 'Harbor hotel' in Nantes
INSERT INTO bedrooms (room_id, room_number, price, hotel_id)
...
-- Amenities for 'Urban Retreat hotel' in Angers
...
-- Amenities for 'Harbor hotel' in Nantes
INSERT INTO amenities (hotel_id, amenity)
VALUES (70, 'Free Wi-Fi'),
       (70, 'Harborfront Terrace'),
       (70, 'Boat Excursions');

-- Booking for 'Urban Retreat hotel' in Angers
